...
import { getAlllTag, getTagById } from "../../tag/api/tagApi";
import {
  getAllEducation,
  getEducationById,
} from "../../education/api/educationApi";
...
import "../scss/subject-detail.scss"
...
const ResourceDetails = () => {
  ...
  const handleUpdate = (id) => {
    navigate(`/admin/supplementaryresource/supplementaryresourceupdate/${id}`);
  };
    ...
    <div className="supplementary-details-container">
      ...
      <div className="supplementary-details-header">
        ...
        <div className="details-wrapper">
          <span className="supplementary-details-education-tittle supplementary-details-title">
             Dersler :
          </span>
          {
          ...
          <span className="supplementary-details-label">
            ...
            resource.resourceType === 2 ? (
              ...
              <div style={{display:"inline"}}>
                ...
                <p style={{display:"inline"}}> ulaşabilirsiniz</p>
              </div>
            ) : resource.fileURL === "Deleted_File" ? (
              "Dosya Silinmiş"
            ) : (
          ...
          <img
            ...
            alt=""
          />
          <span className="supplementary-details-subjects-tittle supplementary-details-title">
            Konular : 
          </span>
          <span className="supplementary-details-subjects supplementary-details-educations">
          {" "}
            {selectedSubjects &&
              Array.from(
                new Set(selectedSubjects.map((subject) => subject.name))
              ).join(", ")}
          </span>
          ...
          <img
            ...
            alt=""
          />
          <span className="supplementary-details-title">Etiketler :</span>
      ...
      <div className="form-buttons">
        <Link
          className="submit-button backto-list custom-back-button"
