...
export const MultipleAutoCompleteSubject = ({
  subjects,
  onSubjectIdSelecting,
}) => {
  const [selectedSubjectIds, setSelectedSubjectIds] = useState([]);

  const getSubjectById = (subjectId) => {
    return subjects.find((subject) => subject.subjectId === subjectId) || { subjectName: '' };
  };
  ...
  return (
    <Stack spacing={3} sx={{ width: "100%" }}>
      <Autocomplete
        ...
        freeSolo
        renderInput={(params) => <TextField {...params} label="Konu Ekle" />}
